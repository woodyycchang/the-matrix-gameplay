...
section('EPANG E6 (the rebuild report acceptance probes)');
{
  ...
  }
  {
    ...
    eq(JSON.stringify(darks.sort()),JSON.stringify(['angel city 1937','epang palace','erebus station','hallway','mobil ave','neon mile','peach blossom']),'uiDark census: the seven DESIGNATED scenes speak code-green, no others');
  }
  {
