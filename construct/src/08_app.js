...
(function (G) {
  ...
  function init() {
    ...
    var defs = [['weapons', 'weapons'], ['dojo', 'dojo'], ['rooftop jump', 'rooftop'], ['motorcycle', 'motorcycle'], ['katana', 'katana'], ['city street', 'city street'], ['neon mile', 'neon'], ['deja vu', 'deja vu'], ['a chair', 'a chair'], ['clear', 'clear']];
