# ORANGE EMPIRE 1937 — this branch's game
...
**▶ Full game & README: [`orange-empire/`](orange-empire/)**

![main street at dusk](orange-empire/shots/01_main_dusk.png)

| the Blue Pacific | the shack |
|---|---|
| ![the Blue Pacific at dusk](orange-empire/shots/02_blue_pacific_dusk.png) | ![the shack](orange-empire/shots/05_shack.png) |
