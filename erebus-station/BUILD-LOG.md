...
## /loop Pass 3(基準 100 → 判定 120+)

改動全在裝飾層(collide:false),物理與可達性圖不變:

- 貼圖:牆板底部油汙列、鉚釘鏽痕、隨機鏽斑;地板磚縫磨損與大面積污漬。霧密度 0.026→0.023,長視線更通透。
- 體積光錐 helper ×5:圓廳天窗、碼頭兩盞工作燈、醫療手術燈、反應爐核心,透明度隨噪聲呼吸。
- 圓廳:穹頂下 8 支放射樑、基座四邊格柵圈、全息柱上升脈衝環。
- 走廊:主走廊與艦橋走廊地緣導引燈。
- 碼頭:西牆燃料軟管與接頭、滑橇下刮痕、西北新增貨箱堆。
- 反應爐:冷卻渠兩側琥珀警示邊線、四角頂-渠冷卻管、核心環形棧橋加四支撐、斷纜處墜落火花粒子。
- 醫療:IV 架與搖晃點滴袋、生化廢桶。
- 水耕:生長燈具座 ×12、地面落葉 ×14。
- 檔案庫:機架頂纜線垂降 ×10、7 號機架整架熄滅(僅剩一顆紅燈)。
- 艦橋:全息台兩側地面光井、上方指揮環含青光圈。
- 寢艙:散落衣物 ×5、翻倒圓凳、兩張暗海報。
- 穹頂:望遠鏡纜線。

判定方式:v2|v3 左右對照六景(dock、rotunda、hydro、med、bridge、reactor),逐張人工檢視,全數「明顯提升」,無回退項。回歸 16/16 通過(536 colliders,20k 物理步 90ms)。
