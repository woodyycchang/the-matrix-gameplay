...
(function (G) {
  ...
  function sceneErebus() {
    ...
    floor(13,-2,17,2,0,'#141a26'); wallZ(-2,13,17,0,3.1); wallZ(2,13,17,0,3.1,undefined);
    ...
    C.addQuadX(m,6,1.5,8.4,2.4,28.97,'#0a1220',false); C.addQuadX(m,10,1.5,12.4,2.4,28.97,'#0a1220',false);
    floor(15,-14,29,-2,0,'#151b28');
    ...
    for (var hp=0; hp<3; hp++){ var hz=-4.4+hp*4.4;
      C.addBox(m,-22,0.5,hz,10,0.5,1.3,'#1a2430',{noBottom:true}); col(-27,0,hz-0.65,-17,0.5,hz+0.65);
    ...
    C.addBox(m,-27.2,1.0,0,1.4,2.0,5.4,'#12314a',{noBottom:true}); col(-27.9,0,-2.7,-26.5,2.0,2.7);
    // ---------------- BALCONY EAST: DATA ARCHIVE ----------------
    floor(13,-14,27,-4,4.6,'#10151f');
    ...
    floor(-13,-13,13,-10.8,4.6,'#11161f'); floor(-13,10.8,13,13,4.6,'#11161f');
    floor(-13,-10.8,-10.8,10.8,4.6,'#11161f'); floor(10.8,-10.8,13,10.8,4.6,'#11161f');
    ...
    floor(-13,-13,13,2.9,12.6,'#0f141e'); floor(-13,13,13,13,12.6,'#0f141e');
    floor(-13,2.9,-12.9,13,12.6,'#0f141e'); floor(-9.4,2.9,13,13,12.6,'#0f141e');   // west strip open for stair arrival
