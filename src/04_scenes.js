...
(function (G) {
  ...
  function sceneDojo() {
    ...
    var s = {
      ...
      groundY: 0, ambience: 'dojo', colliders: [], insts: [], spawn: { pos: [0, 0, 3.2], yaw: Math.PI },   // entry side, facing down the long axis: mats, dummy, receding posts - reads DOJO at frame one
      update: function () {}
    };
    var m = C.newMesh();
    // plank floor
